...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull LinearLayout rootView, @NonNull TextView messageText,
      @NonNull ImageButton speakButton, @NonNull TextView timeText) {
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.speakButton;
      ImageButton speakButton = ViewBindings.findChildViewById(rootView, id);
      if (speakButton == null) {
        break missingId;
      }
      ...
      return new ItemMessageBinding((LinearLayout) rootView, messageText, speakButton, timeText);
    }
