...
public final class ActivityTabbedBinding implements ViewBinding {
  ...
  private ActivityTabbedBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appbar,
      @NonNull ViewPager2 container, @NonNull CoordinatorLayout mainContent,
  ...
  public static ActivityTabbedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTabbedBinding((CoordinatorLayout) rootView, appbar, container, mainContent,
          tabs, toolbar);
    }
